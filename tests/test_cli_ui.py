...
class CliUiTests(unittest.TestCase):
    ...
    def test_render_screen_frame_uses_black_and_white_theme(self) -> None:
        ...
        self.assertTrue(lines[0].startswith("\x1b[1;37;40m+\x1b[0m"), lines[0])
        self.assertIn("\x1b[30;47m- Dev Loop", lines[0])
        selected = next(line for line in lines if "> 1. Models per role" in line)
        self.assertTrue(selected.startswith("\x1b[1;37;40m|\x1b[0m"), selected)
        self.assertTrue(selected.endswith("\x1b[1;37;40m|\x1b[0m"), selected)
        ...
        self.assertTrue(shortcuts.startswith("\x1b[1;37;40m|\x1b[0m"), shortcuts)
        self.assertTrue(shortcuts.endswith("\x1b[1;37;40m|\x1b[0m"), shortcuts)
