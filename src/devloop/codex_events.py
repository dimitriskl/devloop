"""Parsing and safe rendering of the Codex CLI event stream.

This module owns the Codex wire vocabulary only. Domain types such as the
Run-Wide Blocker, and the translation of these events into neutral step
activity, belong to the Execution Backend boundary instead.
"""
